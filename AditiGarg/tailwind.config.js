  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        glow: "hsl(var(--glow))", "terminal-green": "hsl(var(--terminal-green))",
      ...
      keyframes: {
        ...
        "pulse-glow": { "0%, 100%": { boxShadow: "0 0 20px hsl(var(--glow) / 0.3)" }, "50%": { boxShadow: "0 0 40px hsl(var(--glow) / 0.6)" } },
      ...
      animation: {
        ...
        "typing": "typing 3.5s steps(40, end)", "blink": "blink 0.75s step-end infinite",
        "float": "float 3s ease-in-out infinite", "pulse-glow": "pulse-glow 2s ease-in-out infinite",
        "slide-up": "slide-up 0.6s ease-out", "fade-in": "fade-in 0.5s ease-out", "scale-in": "scale-in 0.3s ease-out",
      },
    },
  },
